#!/bin/bash
#SBATCH --job-name=vizdoom_my_way_home_ppo_no_lstm
#SBATCH -A csci5527
...
$PYTHON train_mark_no_lstm.py --timesteps 15000000 --checkpoint-freq 750000 --seed 5527 --scenario-id "$SCENARIO_ID" --environment-class "$ENVIRONMENT_CLASS"
