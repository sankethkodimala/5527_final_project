#!/bin/bash
#SBATCH --job-name=vizdoom_defend_center_10m
#SBATCH -A csci5527
...
$PYTHON train.py --timesteps 10000000 --checkpoint-freq 200000 --seed 5527 \
  --scenario-id "$SCENARIO_ID" --environment-class "$ENVIRONMENT_CLASS"
