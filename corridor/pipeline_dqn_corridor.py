...
class CorridorDQNPipeline:
    """
    DQN pipeline for VizdoomDeadlyCorridor-v1.
    ...
    def __init__(
        self,
        doom_env_id="VizdoomDeadlyCorridor-v1",
        action_space=None,
    ):
        self.doom_env_id = doom_env_id
        self.action_space = action_space or CORRIDOR_DISCRETE_ACTIONS
