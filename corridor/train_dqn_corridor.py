...
from corridor.pipeline_dqn_corridor import CorridorDQNPipeline
...
def train(
    ...
    ml_pipeline = CorridorDQNPipeline(
        doom_env_id=SCENARIO_ID,
        action_space=CORRIDOR_DISCRETE_ACTIONS,
    )
    ...
    eval_pipeline = CorridorDQNPipeline(
        doom_env_id=SCENARIO_ID,
        action_space=CORRIDOR_DISCRETE_ACTIONS,
    )
